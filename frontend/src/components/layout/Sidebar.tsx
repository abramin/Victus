    ...
    <aside className="w-56 bg-black border-r border-gray-800 flex flex-col min-h-screen">
      ...
      <div className="p-3 border-t border-gray-800">
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-400 hover:text-white hover:bg-gray-800/50 transition-colors"
        >
          {isLightMode ? (
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
