...
- Review expensive calculations (adaptive TDEE, training load) and suggest precompute or caching when needed.
...
- Are history endpoints efficient for 30/90/all time ranges?
- Are charts pulling only needed columns (avoid wide row loads for graphs)?
